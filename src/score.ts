...
import {Animator, Billboard, engine, Entity, GltfContainer, Schemas, Transform} from '@dcl/sdk/ecs'
...
export module ScoreObject {
    ...
    const SCORE_SCALE = Vector3.scale(Vector3.One(), 4.5)
    ...
    export function Enable(entity: Entity, scoreData: ScoreDataObject): Entity {
        ...
        Transform.getMutable(entity).scale = SCORE_SCALE
