...
const projectPath = 'https://github.com/chaporovag/carnaval_hockey-dcl'
const description = 'Press left button to throw puck.\nSecond click will retrieve the puck.\nScore at least 30 goals in one minute to win'
const Max_Chars = 100
    ...
    >
        <UiEntity
            ...
            onMouseDown={() => {
                ...
                openExternalUrl({ url: projectPath })
            }}
        />
        <Label
            value="View code"
