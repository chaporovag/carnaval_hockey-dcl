...
class PhysWorld {
  ...
  constructor() {
    ...
    [Materials.PUCK, Materials.WALL, Materials.GROUND].forEach((name) => this.createMaterial(name));

    this.createMaterial(Materials.GROUND);
    const groundMaterial = this.getMaterial(Materials.GROUND);
  ...
  private createMaterial(name: Materials): CANNON.Material {
